  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#E0BFBF] text-gray-600 transition hover:bg-[#F7EDEE] disabled:cursor-not-allowed disabled:opacity-40"
      >
        ‹
      </button>
